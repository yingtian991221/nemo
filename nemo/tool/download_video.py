...
if __name__ == '__main__':
    ...
    parser.add_argument('--video_dir', type=str, required=True, default = '/home/yingtian/nemo-docker/nemo/dataset/video')
    # parser.add_argument('--youtubedl_path', type=str, default='/usr/local/bin/youtube-dl')
    parser.add_argument('--youtubedl_path', type=str, default='yt-dlp')
